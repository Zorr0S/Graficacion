...
//Variables Gobales
let SeleccionMetodo: string = "Directo";
let SeleccionHerramienta: string = "Linea";
let NLados: number = 3;
...
function HandleMetodo(X: any) {
  console.log(X.value);
  SeleccionMetodo = X.value;
}
function HandleHerramienta(X: any) {
  console.log(X.value);
  SeleccionHerramienta = X.value;
}
...
function Selector(
  ...
  let MetodoDibujo: Function = DibujarLineaDirecta;
  switch (Metodo) {
    case "DDA":
      MetodoDibujo = DibujarLineaDDA;
      break;
    case "Bresenhan":
      MetodoDibujo = DibujarLineaBresenhan;

      break;

    default:
      MetodoDibujo = DibujarLineaDirecta;
...
function Prueba() {
  ...
  function PruebaDesempeno(MetodoDibujo: Function, Cadena: string) {
    ...
    console.log(`${Cadena}: ${seconds}`);
  }
  PruebaDesempeno(DibujarLineaDirecta, "Metodo Directo");
  Limpiar();
  PruebaDesempeno(DibujarLineaDDA, "Metodo DDA");
  Limpiar();
  PruebaDesempeno(DibujarLineaBresenhan, "Bresenhan");
