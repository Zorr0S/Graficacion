...
//Variables Gobales
let SeleccionMetodo = "Directo";
let SeleccionHerramienta = "Linea";
let NLados = 3;
...
//ALgoritmos
function Selector(Metodo, Herramienta, Punto0, Punto1) {
    let MetodoDibujo = DibujarLineaDirecta;
    switch (Metodo) {
        case "DDA":
...
function Prueba() {
    ...
    function PruebaDesempeno(MetodoDibujo, Cadena) {
