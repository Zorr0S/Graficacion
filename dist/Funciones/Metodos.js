...
export { Punto };
export function DibujarPixel(ctxt, X, Y) {
    ctxt.fillStyle = "#197BBD";
    ctxt.fillRect(X, Y, 3, 3);
    ctxt.stroke();
}
export function MetodoBresenhan(ctxt, CoordenadaInicial, CoordenadaFinal) {
...
export function DibujarLineaBresenhan(context, Coordnada0, Coordnada1) {
